...
#+HTML: }
#+HTML: .badge.open-access {
#+HTML:   background: #fdbc4b;
#+HTML:   font-weight: bold;
#+HTML: }
#+HTML: </style>
#+HTML: <div id="pubmed-results">Loading...</div>
#+HTML: <script src="pubmed.js"></script>
#+HTML: <script src="https://d1bxh8uas1mnw7.cloudfront.net/assets/embed.js" async></script>
